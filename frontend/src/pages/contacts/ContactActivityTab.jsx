      ...
      <div className="max-w-3xl mx-auto">
        ...
        {items.length === 0 ? (
          ...
          <div className="space-y-2">
            {items.map((a) => (
              <div key={a.id} className="rounded-2xl bg-white/60 dark:bg-slate-900/40 backdrop-blur-xl border border-slate-200/60 dark:border-white/10 shadow-sm p-4 flex gap-3 transition-all hover:-translate-y-0.5">
